...
export const ResponsiveHeader: React.FC = () => {
  return (
    <div className="self-stretch bg-gray-50 flex flex-row items-start justify-start mq768:pt-0 mq768:px-0 mq768:pb-10 box-border max-w-full top-[0] z-[99] sticky mq1920:text-left mq1920:text-base mq1920:text-gray-600 mq1920:font-text-md-regular mq1920:border-b-1 mq1920:border-solid mq1920:border-gray-10">
